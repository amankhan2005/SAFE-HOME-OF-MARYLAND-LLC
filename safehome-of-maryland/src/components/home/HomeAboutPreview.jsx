        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative lg:col-span-5 h-[450px] lg:h-[580px]">
            ...
            <div className="relative z-10 w-full h-[85%] rounded-2xl overflow-hidden shadow-2xl transform lg:rotate-1 transition-transform duration-500 hover:rotate-0">
              <img
                ...
                alt="Support staff assisting adult with developmental disabilities in daily activities"
            ...
            <div className="absolute z-20 bottom-0 left-0 lg:left-4 w-2/3 h-1/3 rounded-xl overflow-hidden shadow-xl border-4 border-white transform -rotate-2 hover:rotate-0 transition-transform duration-300">
              <img
                src="/images/hero.jpeg" // Swap this for a secondary image
                alt="Happy resident"
          ...
          <div className="lg:col-span-7 lg:pl-12">
            ...
            <p className="text-lg text-gray-600 mb-10 leading-relaxed border-l-2 border-gray-100 pl-6">
              At <strong className="text-[#1F2F2F]">Safe Home of Maryland</strong>, we provide person-centered support for individuals with intellectual and developmental disabilities.
              Our approach focuses on building independence, encouraging community involvement, and helping each individual live a meaningful and fulfilling life.
            </p>
            ...
            <div className="space-y-6 mb-10 relative">
              ...
              <div className="flex items-start gap-4 relative">
                ...
                <div>
                  <h3 className="font-bold text-[#1F2F2F] text-lg">Safe & Respectful Environment</h3>
                  <p className="text-gray-500 text-sm mt-1">A supportive setting where individuals feel valued, secure, and comfortable every day.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 relative">
                ...
                <div>
                  <h3 className="font-bold text-[#1F2F2F] text-lg">Personalized Support Plans

                  </h3>
                  <p className="text-gray-500 text-sm mt-1">Services designed around each individual’s goals, preferences, and unique needs.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 relative">
                ...
                <div>
                  <h3 className="font-bold text-[#1F2F2F] text-lg">Building Independence
                  </h3>
                  <p className="text-gray-500 text-sm mt-1">Helping individuals develop skills, confidence, and greater independence in daily life.</p>
                </div>
              </div>
