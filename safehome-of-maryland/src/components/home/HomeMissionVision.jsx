 const HomeMissionVision = () => {
  ...
  <span className="w-8 h-[2px] bg-[#E68A3F]"></span>
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#1F2F2F] tracking-tight">
            Driven by Care, Defined by Values
          </h2>
        </div>

        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          
          {/* MISSION CARD - Warm Theme */}
          <div className="group relative bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To provide high-quality, person-centered care that enhances the physical, emotional, and social well-being of every individual. We are committed to promoting dignity, independence, and a better quality of life.
              </p>
            </div>
          </div>

          {/* VISION CARD - Cool Theme */}
          <div className="group relative bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To create a future where every individual, regardless of their challenges, can live with dignity, purpose, and happiness. We strive to be a trusted leader in compassionate residential care.
              </p>
            </div>
          </div>
