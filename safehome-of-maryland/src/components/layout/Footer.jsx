  ...
  <div className="bg-white p-2 rounded-lg shadow-md inline-block">
    ...
    />
            ...
            {/* <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#E68A3F] hover:text-white hover:border-[#E68A3F] transition-all duration-300">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  <a href="mailto:safehomeofmaryland@gmail.com" className="text-white hover:text-[#E68A3F] transition-colors">
              ...
              {/* <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-white">+1 XXX XXX XXXX</p>
