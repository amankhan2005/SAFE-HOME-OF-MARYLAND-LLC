                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 mt-1">1337 Tralee Circle<br />Aberdeen, MD 21001</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#1F2F2F]">Phone Number</h4>
                      <p className="text-gray-500 mt-1">+1 XXX XXX XXXX</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 mt-1">info@safehomeofmaryland.com</p>
                    </div>
                  </div>
                </div>
              </div>
