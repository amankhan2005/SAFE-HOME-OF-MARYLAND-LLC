      ...
      <section className="relative min-h-[50vh] lg:min-h-[60vh] flex items-center justify-center bg-[#1F2F2F] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 py-20">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-6">
            Supporting Lives with <br />
            <span className="text-[#EED4B7]">Dignity & Independence</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            We provide a supportive environment where individuals with intellectual and developmental disabilities can grow, build independence, and feel a true sense of belonging.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative lg:col-span-5 h-[450px] lg:h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 lg:left-10 w-2/3 h-1/3 rounded-xl overflow-hidden shadow-xl border-4 border-white z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                <img
                  src="/images/hero.jpeg" // Secondary image
                  alt="Happy resident"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1F2F2F] leading-tight tracking-tight mb-6">
                ...
                <span className="text-[#2F5D5E]">Individuals Across Maryland</span>
              </h2>

              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  <span className="font-semibold text-[#1F2F2F]">SAFE HOME OF MARYLAND LLC</span> is a trusted provider of support services for individuals with intellectual and developmental disabilities.
                </p>
                <p>
                  Our goal is to create a safe and supportive environment where individuals can thrive. We focus on personalized support that promotes independence, dignity, and meaningful daily living.
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="group relative bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  To provide person-centered support that empowers individuals to live with dignity, build independence, and actively participate in their communities.
                </p>
              </div>
            </div>
            ...
            <div className="group relative bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  To build a future where every individual has the opportunity to live independently, feel included, and lead a meaningful life.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group p-8 bg-[#F9FAFB] rounded-2xl border border-gray-100 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <h4 className="text-lg font-bold text-[#1F2F2F] mb-2">
                Respectful & Person-Centered Support
              </h4>
              <p className="text-gray-500 text-sm leading-relaxed">
                We support every individual with dignity, respect, and compassion in everything we do.
              </p>
            </div>
            ...
            <div className="group p-8 bg-[#F9FAFB] rounded-2xl border border-gray-100 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Our trained team provides consistent, high-quality support 24/7 in a safe and structured environment.
              </p>
            </div>
            ...
            <div className="group p-8 bg-[#F9FAFB] rounded-2xl border border-gray-100 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                A secure and welcoming space where individuals feel comfortable, valued, and supported.
              </p>
            </div>
            ...
            <div className="group p-8 bg-[#F9FAFB] rounded-2xl border border-gray-100 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#2F5D5E]/10 flex items-center justify-center text-[#2F5D5E] mb-6 group-hover:bg-[#2F5D5E] group-hover:text-white transition-all duration-300">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
              </div>
              <h4 className="text-lg font-bold text-[#1F2F2F] mb-2">
                Community & Independence Focus
              </h4>
              <p className="text-gray-500 text-sm leading-relaxed">
                We encourage community involvement while helping individuals build independence and confidence.
              </p>
            </div>
